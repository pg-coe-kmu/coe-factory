...
|---|---|---|---|---|---|
| **A1** | **Vertrag BC1→BC2** | `contracts/bc1-to-bc2/prozessprofil.schema.json` mit Beispiel — Typen und Einheiten der vier Größen, TP-ID als Anker, `erhebung_id`-Lesart (Klärpunkt **K-L**: die Sicht ist itemweise aktuell, wir speichern eine ID) | BC2 schneidet gegen die Zeilen vom 08.09. (#184, v3.0 in #187); BC1 liefert Spalte-zu-Feld-Tabelle + `pruef.sql`-Muster als Eingang | BC2 + Platform (CODEOWNERS) | S |
